...
public class JournalisationHelper
{
     ...
     */
    public static void insert(org.omg.CORBA.Any a, journalisation.Journalisation t)
    {
     ...
     */
    public static journalisation.Journalisation extract(org.omg.CORBA.Any a)
    {
        if (!a.type().equal(type()))
            throw new org.omg.CORBA.MARSHAL();
        try {
            return journalisation.JournalisationHelper.narrow(a.extract_Object());
    ...
    private final static String _id = "IDL:journalisation/Journalisation:1.0";
     ...
     */
    public static journalisation.Journalisation read(org.omg.CORBA.portable.InputStream istream)
    {
        return(journalisation.Journalisation)istream.read_Object(journalisation._JournalisationStub.class);
    }
     ...
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, journalisation.Journalisation value)
    {
