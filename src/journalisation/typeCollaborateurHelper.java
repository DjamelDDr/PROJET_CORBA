...
public class typeCollaborateurHelper
{
     ...
     */
    public static void insert(org.omg.CORBA.Any a, journalisation.typeCollaborateur t)
    {
        a.type(type());
     ...
     */
    public static journalisation.typeCollaborateur extract(org.omg.CORBA.Any a)
    {
    ...
    private final static String _id = "IDL:journalisation/typeCollaborateur:1.0";
     ...
     */
    public static journalisation.typeCollaborateur read(org.omg.CORBA.portable.InputStream istream)
    {
     ...
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, journalisation.typeCollaborateur value)
    {
