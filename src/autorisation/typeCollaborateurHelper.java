...
public class typeCollaborateurHelper
{
     ...
     */
    public static void insert(org.omg.CORBA.Any a, autorisation.typeCollaborateur t)
    {
        a.type(type());
     ...
     */
    public static autorisation.typeCollaborateur extract(org.omg.CORBA.Any a)
    {
    ...
    private final static String _id = "IDL:autorisation/typeCollaborateur:1.0";
     ...
     */
    public static autorisation.typeCollaborateur read(org.omg.CORBA.portable.InputStream istream)
    {
     ...
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, autorisation.typeCollaborateur value)
    {
