...
public final class Collaborateur implements org.omg.CORBA.portable.IDLEntity
{
     ...
     */
    public autorisation.typeCollaborateur tcollab;
     ...
     */
    public Collaborateur(int idCollab, String nom, String prenom, String mdp, String photo, autorisation.typeCollaborateur tcollab)
    {
