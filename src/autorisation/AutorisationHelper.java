...
public class AutorisationHelper
{
     ...
     */
    public static void insert(org.omg.CORBA.Any a, autorisation.Autorisation t)
    {
     ...
     */
    public static autorisation.Autorisation extract(org.omg.CORBA.Any a)
    {
        if (!a.type().equal(type()))
            throw new org.omg.CORBA.MARSHAL();
        try {
            return autorisation.AutorisationHelper.narrow(a.extract_Object());
    ...
    private final static String _id = "IDL:autorisation/Autorisation:1.0";
     ...
     */
    public static autorisation.Autorisation read(org.omg.CORBA.portable.InputStream istream)
    {
        return(autorisation.Autorisation)istream.read_Object(autorisation._AutorisationStub.class);
    }
     ...
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, autorisation.Autorisation value)
    {
