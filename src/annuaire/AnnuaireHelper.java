...
public class AnnuaireHelper
{
     ...
     */
    public static void insert(org.omg.CORBA.Any a, annuaire.Annuaire t)
    {
     ...
     */
    public static annuaire.Annuaire extract(org.omg.CORBA.Any a)
    {
        if (!a.type().equal(type()))
            throw new org.omg.CORBA.MARSHAL();
        try {
            return annuaire.AnnuaireHelper.narrow(a.extract_Object());
    ...
    private final static String _id = "IDL:annuaire/Annuaire:1.0";
     ...
     */
    public static annuaire.Annuaire read(org.omg.CORBA.portable.InputStream istream)
    {
        return(annuaire.Annuaire)istream.read_Object(annuaire._AnnuaireStub.class);
    }
     ...
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, annuaire.Annuaire value)
    {
