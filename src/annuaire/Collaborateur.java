...
public final class Collaborateur implements org.omg.CORBA.portable.IDLEntity
{
     ...
     */
    public annuaire.typeCollaborateur tcollab;
     ...
     */
    public Collaborateur(int idCollab, String nom, String prenom, String mdp, String photo, annuaire.typeCollaborateur tcollab)
    {
