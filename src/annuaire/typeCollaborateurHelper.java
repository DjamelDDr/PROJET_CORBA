...
public class typeCollaborateurHelper
{
     ...
     */
    public static void insert(org.omg.CORBA.Any a, annuaire.typeCollaborateur t)
    {
        a.type(type());
     ...
     */
    public static annuaire.typeCollaborateur extract(org.omg.CORBA.Any a)
    {
    ...
    private final static String _id = "IDL:annuaire/typeCollaborateur:1.0";
     ...
     */
    public static annuaire.typeCollaborateur read(org.omg.CORBA.portable.InputStream istream)
    {
     ...
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, annuaire.typeCollaborateur value)
    {
