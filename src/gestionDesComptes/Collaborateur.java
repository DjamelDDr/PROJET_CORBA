...
public final class Collaborateur implements org.omg.CORBA.portable.IDLEntity
{
     ...
     */
    public gestionDesComptes.typeCollaborateur tcollab;
     ...
     */
    public Collaborateur(int idCollab, String nom, String prenom, String mdp, String photo, gestionDesComptes.typeCollaborateur tcollab)
    {
