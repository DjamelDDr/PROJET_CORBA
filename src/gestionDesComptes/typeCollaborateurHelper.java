...
public class typeCollaborateurHelper
{
     ...
     */
    public static void insert(org.omg.CORBA.Any a, gestionDesComptes.typeCollaborateur t)
    {
        a.type(type());
     ...
     */
    public static gestionDesComptes.typeCollaborateur extract(org.omg.CORBA.Any a)
    {
    ...
    private final static String _id = "IDL:gestionDesComptes/typeCollaborateur:1.0";
     ...
     */
    public static gestionDesComptes.typeCollaborateur read(org.omg.CORBA.portable.InputStream istream)
    {
     ...
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, gestionDesComptes.typeCollaborateur value)
    {
