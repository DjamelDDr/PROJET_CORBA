...
public final class Collaborateur implements org.omg.CORBA.portable.IDLEntity
{
     ...
     */
    public entreeSortie.typeCollaborateur tcollab;
     ...
     */
    public Collaborateur(int idCollab, String nom, String prenom, String mdp, String photo, entreeSortie.typeCollaborateur tcollab)
    {
